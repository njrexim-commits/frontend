        ...
        >
          <div
            className={`absolute inset-0 bg-cover bg-center ${
              index === currentSlide ? "animate-zoom-slow" : ""
            }`}
        ...
        <div className="container-custom">
          <div className="max-w-2xl animate-fade-in">
            ...
            <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-xl">
              Explore our diverse range of top-quality export products including 
              premium rice, fresh fruits, vegetables, spices, and essential food items. 
              We deliver consistent quality that meets international standards and 
